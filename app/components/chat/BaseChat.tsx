          ...
          <div className={classNames(styles.Chat, 'flex flex-col flex-grow lg:min-w-[var(--chat-min-width)] h-full')}>
            {!chatStarted && (
              <div id="intro" className="mt-[16vh] max-w-chat mx-auto text-center px-4 lg:px-0">
                <h1 className="text-4xl lg:text-3xl font-bold text-bolt-elements-textPrimary mb-4 animate-fade-in">
                  Build your app in minutes, not months
                </h1>
                <p className="text-md lg:text-xl mb-8 text-bolt-elements-textSecondary animate-fade-in animation-delay-200">
                  Bring ideas to life - AI-generated apps and sites ready in minutes, no coding required.
                </p>
              </div>
            )}
            <div
